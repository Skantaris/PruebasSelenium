...
public class AppTest 
{
    ...
    public void TestConsultarPrimarAnual(String genero, String edad, String salida_esperada) throws InterruptedException
    {
        Thread.sleep(1000);
        ...
        assertEquals(salida_esperada, 
            driver.findElement(bodySelector).getText());
    }
